      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            SizedBox(height: 40,),
            Text('코골이를 안 할 수 있는\n 방법이 있을까요?',
              style: TextStyle(color: Colors.white, fontSize: 24, fontWeight: FontWeight.w700,fontFamily: 'SUIT', fontStyle: FontStyle.normal, height: 36/24),
            ...
            style: TextStyle(color: Colors.white, fontSize: 14, fontWeight: FontWeight.w600,fontFamily: 'SUIT', fontStyle: FontStyle.normal, height: 22/14),),
            SizedBox(height: 24,),
            Text('* 콘텐츠의 내용은 의사 및 간호사의\n의학적 지식을 자문 받아 제작되었습니다.',
              style: TextStyle(color: Colors.grey, fontSize: 12, fontWeight: FontWeight.w500,fontFamily: 'SUIT', fontStyle: FontStyle.normal, height: 18/12) ,),
          ],
        ),
      ),
    );
